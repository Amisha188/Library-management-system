...
<body>
    ...
    <div class="container">
        <div class="image">
            <img src="invention.JPG">
        
        <div class="info">
            <span>
            <h2>Books about Invention and Innovation </h2><br>
            <p>Edited by</p>
            <p>Davis, Kathryn and Gilbert Ford</p>
        ...
        <div class="info">
            <span>
            <h2>World Rivers</h2><br>
            <p>Presented by</p>
            <p> Core Knowledge Foundation</p>
            <button type="button" id="btn">Read</button>
            </span>
        </div>
        </div>
        ...
        <div class="info">
            <span>
            <h2>A HAND BOOK FOR TEACHING SPORTS</h2><br>
            <button type="button" id="btn">Read</button>
            </span>
        </div>
        </div>
        ...
        <div class="info">
            <span>
            <h2>General financial rules</h2><br>
            <p>Presented by</p>
